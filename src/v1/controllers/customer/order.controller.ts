...
import {
  createOrderService,
  getPaginatedOrderListService,
} from "../../services/customer/order.services.js"

export const createOrderController: IAuthedUserRequestHandler = async (
  req,
  res,
  next
) => {
...
export const listCustomerOrdersController: IAuthedUserRequestHandler<
  {
    customerId: number
  },
  {},
